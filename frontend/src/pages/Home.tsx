    ...
    return (
        <>
            ...
            <section className="section container">
                ...
                <div className="prose">
                    <p>
                        Since 2016, Social Coding has been a vibrant community where students collaborate on projects,
                        learn industry skills, and express their creativity through technology. Our foundation lies in
                        the shared passion of friends coding together and the desire to bridge the gap between
                        coursework and industry. As such, our mission is to create a dynamic space for students of all
                        backgrounds and disciplines to learn from one another and create amazing code.
                    </p>

                    <p>
                        Social Coding is dedicated to breaking the barrier of entry into Software Engineering, we
                        believe that everyone has something to contribute and thus do not require any prior experience
                        to join.
                    </p>
                </div>
            </section>
            ...
            <section className="section container">
                ...
                <ol className="timeline">
                    ...
                    <li>
                        <h3>Build time</h3>
                        <p>Turn the design doc into working software through hard work.</p>
                    </li>

                    <li>
                        <h3>MVP presentation</h3>
                        <p>Demo a working core to the club, present a thorough slideshow of your idea, or any means to
                            gather the feedback you and your team need.</p>
                    </li>
            ...
            {board.length > 0 && (
                <section className="section container">
                    ...
                    <ul className="board-list">
                        {board.map((p) => (
                            <li key={p.id} className="board-person">
                                {p.avatarUrl ? (
                                    <img className="avatar" src={p.avatarUrl} alt="" referrerPolicy="no-referrer"/>
                                ) : (
                                ...
                                <div>
                                    <p className="board-name">{p.name}</p>
                                    <p className="board-title mono">{p.title ?? 'Board'}</p>
                                </div>
                            </li>
                        ))}
                    </ul>
