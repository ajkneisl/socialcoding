...
const heart = (filled: boolean) => (
    <svg
        ...
        aria-hidden="true"
    >
        <path d="M12 21s-7.5-4.6-10-9.2C.6 9 1.7 5.5 5 5.5c2 0 3.2 1.2 4 2.3.8-1.1 2-2.3 4-2.3 3.3 0 4.4 3.5 3 6.3-2.5 4.6-10 9.2-10 9.2z" />
    </svg>
)
...
export function LikeButton({ project }: { project: Project }) {
    ...
    return (
        <button
            ...
            className={`${base} transition-colors disabled:opacity-60 ${
