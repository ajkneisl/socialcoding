 ...
 *
 * The list is saved as submitted. Presentation milestones are stamped when a design doc is filed
 * (see [com.socialcoding.projects.stampPresentationMilestones]); editing deliverables afterwards
 * doesn't re-add them.
 */
val UPDATE_TASKS: suspend RoutingContext.() -> Unit = {
    ...
    transaction {
        ...
        replaceTasks(projectID, body.tasks, teamIds)
    }
